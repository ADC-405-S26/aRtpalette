...
The `aRtpalette` package provides tools for creating, visualizing, and applying art-inspired color palettes in R. It is designed to allow users to work with colors from famous artworks so they feel natural and streamlined. To install this package from GitHub, use
